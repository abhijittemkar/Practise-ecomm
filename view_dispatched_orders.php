...
$sql = "SELECT * FROM orders WHERE order_status = 'dispatched'";
...
<body>
    ...
    <table border="1">
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<tr><td colspan="9">No dispatched orders found.</td></tr>';
        }
        ?>
    </table>
